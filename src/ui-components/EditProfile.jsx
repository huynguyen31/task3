...
export default function EditProfile(props) {
  const { author, overrides, ...rest } = props;
  const [
  ...
  const buttonOnClick = useDataStoreUpdateAction({
    fields: {
      name_name: textFieldTwoNineSevenSixSixNineTwoTwoValue,
      avatar: textFieldTwoNineSevenSixSixNineTwoThreeValue,
